...
public class ListaCliente extends Activity implements OnCreateContextMenuListener{
    ...
    private AdapterCliente adapterListView;
    ...
    private void createListView() {
        ...
        //Cria o adapter
    	adapterListView = new AdapterCliente(this, itens);
        //Define o Adapter
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		if (item.getItemId() == CONTEXTMENUITEM_EDIT) {
			...
			Bundle b = new Bundle();
			Intent i = new Intent();
			b.putString("nome", cliente.getNome());
			b.putString("endereco", cliente.getEndereco());
			b.putString("telefone", cliente.getTelefone());
			i.putExtras(b);
